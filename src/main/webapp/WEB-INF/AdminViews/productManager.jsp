                    ...
                    <tr>
                        ...
                        <td style="color: #e64a19; font-weight: bold;">
                            <c:choose>
                                ...
                                <%-- Nếu Giá Thấp Nhất BẰNG Giá Cao Nhất (Hoặc chỉ có 1 giá) --%>
                                <c:when test="${p.display_price == p.display_max_price}">
                                    <fmt:formatNumber value="${p.display_price}" pattern="#,###"/> VNĐ
                                </c:when>
