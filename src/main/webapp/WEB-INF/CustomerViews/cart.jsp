                    ...
                    <table class="cart-table">
                        ...
                        <tbody>
                            <c:forEach var="item" items="${cart.items}">
                                <tr>
                                    <td>
                                        <input type="checkbox" name="selectedVariants" value="${item.productVariantId}" class="custom-checkbox item-checkbox" data-price="${item.totalPrice}" checked>
                                    </td>
                                    ...
                                    <td>
                                        <div class="item-info">
                                            ...
                                            <div>
                                                ...
                                                <div class="item-variant">Mã Phân Loại: ${item.productVariantId}</div>
                                                <div class="item-variant">Kích cỡ: ${item.productVariant.size} | Màu sắc: ${item.productVariant.color}</div>
                                            </div>
                                        </div>
                                    </td>
                                    
                                    <td class="price-text">${item.unitPrice}đ</td>
                                    
                                    <td>
                                        <div class="qty-control">
                                            <a href="${pageContext.request.contextPath}/cart?action=decrease&variantId=${item.productVariantId}" class="qty-btn">-</a>
                                            <span class="qty-number">${item.amount}</span>
                                            <a href="${pageContext.request.contextPath}/cart?action=add&variantId=${item.productVariantId}&quantity=1" class="qty-btn">+</a>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <a href="${pageContext.request.contextPath}/cart?action=remove&variantId=${item.productVariantId}" class="btn-remove" onclick="return confirm('Bỏ sản phẩm này?');">Xóa</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
