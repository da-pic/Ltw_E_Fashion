...
<head>
    ...
    <style>
        ...
        .address-form-wrapper {
            max-height: 0; overflow: hidden; transition: max-height 0.4s ease-out, margin-top 0.4s ease; background-color: #fafafa; border-radius: 4px;
        }
        ...
        .saved-address-form {
            border: 1px solid #e8e8e8; padding: 20px; margin-bottom: 20px; 
            border-radius: 4px; background-color: #fafafa; position: relative;
        }
        ...
        .address-field.full-width { grid-column: span 2; }
        
        .mock-disabled {
            flex: 1; padding: 10px; border: 1px solid #ddd; border-radius: 2px; font-family: Arial, sans-serif; box-sizing: border-box;
            background-color: #ebebeb; color: #777; pointer-events: none; /* Khóa không cho click/nhập */
        }
        ...
        .edit-toggle-cb:checked ~ .grid-inputs .mock-disabled {
            background-color: #fff; color: #333; pointer-events: auto; border-color: #ccc; 
        }

        .edit-toggle-cb:checked ~ .saved-address-actions .btn-sua,
        .edit-toggle-cb:checked ~ .saved-address-actions .btn-xoa { display: none; }
        
        .edit-toggle-cb:checked ~ .saved-address-actions .btn-huy,
        .edit-toggle-cb:checked ~ .saved-address-actions .btn-luu { display: inline-block; }

        .empty-address { text-align: center; padding: 30px; color: #888; font-size: 14px; }
    </style>
</head>
<body>
    ...
    <div class="container">
        ...
        <div class="address-section">
            ...
            <c:if test="${not empty error}">
                <div style="background-color: #fff0ee; color: #ee4d2d; border: 1px solid #ee4d2d; padding: 10px; margin-bottom: 15px; border-radius: 4px;">
            ...
            <div class="address-list">
                <c:choose>
                    <c:when test="${empty addressList}">
                        <div class="empty-address">Bạn chưa có địa chỉ giao hàng nào.</div>
                    </c:when>
                    <c:otherwise>
